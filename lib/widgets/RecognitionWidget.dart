...
import 'package:calcam/Utils/Logger.dart'; // logger
import 'package:calcam/Utils/camera.dart'; // camera
import 'package:calcam/services/recognizer.dart'; // recognizer
  ...
  void initState() {
    ...
    TFLiteHelper.tfLiteResultsController.stream.listen((value) {
      ...
      setState(() {
        ...
        CameraLoader.isDetecting = false;
      });
    }, onDone: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<void>(
        future: CameraLoader.initializeControllerFuture,
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            // If the Future is complete, display the preview.
            return Stack(
              children: <Widget>[
                CameraPreview(CameraLoader.camera),
